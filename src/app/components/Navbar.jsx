        ...
        <div className="flex justify-between items-center h-20 relative">
          ...
          <div className="flex-shrink-0">
            <Link href="/" className="block hover:opacity-80 transition-opacity duration-200">
              <img
                src="/images/logo.png"
                alt="Logo"
                className="h-8 w-auto max-w-[100px] md:max-w-[140px] lg:max-w-none"
              />
            </Link>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-6 text-lg">
            <div className="relative">
              <button className="flex items-center text-white bg-green-700 rounded-md p-2 transition">
                Services
            ...
            <Link href="" className="text-gray-700 transition">Our Process</Link>
            <Link href="" className="text-gray-700 transition">Technology</Link>
            <Link href="" className="text-gray-700 transition">Blog</Link>
