      ...
      <section className="px-4 sm:px-6 md:px-8 lg:px-12 py-10 sm:py-12 md:py-16">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 md:gap-12">
                ...
                <li
                  ...
                  className={`flex justify-between items-center w-full border-b border-gray-300 border-l-6 border-l-[#A408CB] pb-2 ${
                    item === "Internationalization"
                      ? "bg-[#F6D1FF] p-6 text-[28px] leading-[32.2px] text-[#A408CB] font-[Inter-Bold] py-3"
          ...
          <div className="md:w-1/2 space-y-5 w-full text-center md:text-left">
            <p className="text-[#5E555C] text-[16px] font-[Inter-Medium] text-base sm:text-lg leading-[19.36px]">
